...
**Dunboro** is a working settlement roughly 60 km from the canyon — the same leg as the shortcut in the section above, flown in reverse — useful for respawn, refuel, and a navigation anchor on the return leg to New Babbage. Between Dunboro and the canyon, unnamed crash sites appear in the tree line with no nav markers: look for antenna arrays above the pines and land next to whatever remains. The tundra along this route is worth flying slowly even when you are not lost.
...
- [RSI Community Hub](https://robertsspaceindustries.com/community-hub) — search "New Canyon River Exploration" for the longform 3.18 PTU canyon river video reference; no stable direct link available
